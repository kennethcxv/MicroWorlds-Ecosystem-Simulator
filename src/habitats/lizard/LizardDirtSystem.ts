 ...
 *  PACING (retuned SLOWER AGAIN on player feedback, 2026-07-02): the ambient
 *  film now takes ~28 hours of play to saturate (a clean tank stays clean
 *  across many sessions); a hotspot needs 8–10 minutes of solid lingering
 *  before a visible spot forms — grime is an occasional cozy chore, never a
 *  treadmill (droppings still foul their patch faster via their 1.4 weight). */
const AMBIENT_PER_SEC = 0.00001;
const HOTSPOT_PER_SEC = 0.0007;
