...
/** Leopard-gecko ideals (mirrors the species care profile; override per
 *  species). Researched bands: basking zone 30–34°C, cool 21–25°C, ambient
 *  humidity 30–40% — the comfort read is slightly forgiving at the edges. */
