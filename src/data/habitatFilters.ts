...
export const HABITAT_FILTERS: HabitatFilterDef[] = [
  {
    ...
    tips: "Aim for a 30–34°C basking zone (the rock surface under the lamp runs warmer still) with a 21–25°C cool retreat opposite — never heat the whole floor.",
    recommendation: "Recommended: 30–34°C basking zone",
  ...
  },
  {
    ...
    tips: "Paint a small damp patch near a hide to make a humid retreat (70%+ inside helps shedding) — keep the open floor dry.",
    recommendation: "Recommended: 30–40% ambient",
  ...
  },
  {
    ...
    icon: "paint",
    tint: "#e8b46a",
    description: "Shows which painted material lines each part of the floor.",
    about: [
      "Substrate Map colours the floor by the material you painted there — sands, clay, gravels, soil and bark each read distinctly.",
      "Mixing substrates like a zoo exhibit is great husbandry: warm clay under the lamp, loose sand for digging, firm soil for burrows.",
    ],
    tips: "Keep at least half the floor diggable sand or soil — decorative gravels and bark are for accents, not the whole run.",
    recommendation: "Recommended: 50%+ diggable ground",
    legend: { low: "Sands", high: "Bark & soil" },
    scale: [
      { t: 0, color: "#d8bd8c" },
      { t: 0.2, color: "#e4d4ac" },
      { t: 0.35, color: "#c9946a" },
