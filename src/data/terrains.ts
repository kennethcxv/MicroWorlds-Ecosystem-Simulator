 ...
 *  just a tint. */
export type SandTextureStyle = "sand" | "pebbles" | "clay" | "rocky" | "ripples" | "litter" | "moss" | "bark" | "soil";
...
export const TERRAINS: TerrainDef[] = [
  ...
  },
  {
    id: "arid_soil",
    name: "Arid Soil",
    description: "Naturalistic sand-soil blend — the keeper's choice for burrows.",
    tags: ["desert", "firm", "dry"],
    swatch: "", // procedural swatch (drawn from the palette at runtime)
    palette: {
      base: "#b3946a",
      patchDark: "#997a52",
      patchLight: "#c9ad82",
    ...
    color: 0xa98c62,
    habitats: ["lizard_terrarium", "desert_terrarium"],
    stats: { heat: 0.7, humidity: 0.3, digging: 0.7, cleanliness: 0.65, bioactive: 0.35 },
    humidityBase: 40,
    humidityHold: 1.05,
  },
  {
    id: "bark_chips",
    name: "Bark Chips",
    description: "Chunky orchid-bark pieces with a warm woodland look.",
    tags: ["decorative", "firm"],
    swatch: "", // procedural swatch (drawn from the palette at runtime)
    palette: {
      base: "#8a6844",
      patchDark: "#6f5233",
    ...
    substrateType: "soil",
    color: 0x7d5f3e,
    habitats: ["lizard_terrarium", "tropical_terrarium"],
    stats: { heat: 0.45, humidity: 0.5, digging: 0.3, cleanliness: 0.75, bioactive: 0.4 },
    humidityBase: 42,
    humidityHold: 1.15,
  },
  {
  ...
  },
  {
    id: "leaf_litter",
    name: "Leaf Litter",
    description: "A soft carpet of fallen leaves over damp forest soil.",
    tags: ["humid", "living", "decorative"],
    swatch: "", // procedural swatch (drawn from the palette at runtime)
    palette: {
      base: "#5f4a2e",
      patchDark: "#4a3820",
    ...
    color: 0x54422a,
    habitats: ["tropical_terrarium"],
    stats: { heat: 0.3, humidity: 0.85, digging: 0.4, cleanliness: 0.4, bioactive: 0.85 },
    humidityBase: 45,
    humidityHold: 1.3,
  },
  {
